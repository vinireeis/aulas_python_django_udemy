...
print(Pessoa.ano_atual)  # esse é um atributo da classe, por isso n preciso instanciar


p3 = Pessoa.por_ano_nascimento('Cintia', 44)  # outra forma de criar uma pessoa pelo ano de nascimento
